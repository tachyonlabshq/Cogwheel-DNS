      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "inset"
              ? "top-0 p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]"
        ...
        >
          <div
            ...
            className={cn(
              ...
              variant === "inset" && "rounded-2xl border border-sidebar-border shadow-sm",
            )}
          >
            {children}
          </div>
